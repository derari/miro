...
import org.cthul.miro.db.sql.SqlJoinableClause.JoinType;
import org.cthul.miro.db.sql.syntax.MiSqlParser;
import org.cthul.miro.db.syntax.QlCode;
import org.cthul.miro.util.Key;
import org.cthul.miro.composer.sql.template.JoinedView;
...
public interface SqlTemplatesBuilder<This extends SqlTemplatesBuilder<This>> {
    ...
    interface Using<B extends SqlTemplatesBuilder<B>> extends SqlTemplatesBuilder<B> {
        ...
        default B define(Consumer<? super B> action) {
            class UDelegator implements SqlTemplatesBuilderDelegator<B> {
                @Override
