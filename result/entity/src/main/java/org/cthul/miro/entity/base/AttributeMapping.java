 ...
 * @param <Entity>
 */
public class AttributeMapping<Entity> 
                extends AttributeMappingBase<Entity, RuntimeException, AttributeMapping<Entity>> 
                implements EntityConfiguration<Entity>, AttributeConfiguration<Entity> {
    ...
    public EntityConfiguration<Entity> forAttributes(List<?> attributes) {
        AttributeMapping copy = new AttributeMapping();
