 ...
 */
public class SimpleMiQueryString extends QlBuilderDelegator<SimpleMiQueryString> implements MiQueryString {
     ...
     */
    SimpleMiQueryString(MiQueryString queryString, Syntax syntax) {
        super(syntax);
